...
import { DeckCardsComponent } from '../deck-cards-information/deck-cards-information.component';

@Component({
  selector: 'app-deck-information',
  standalone: true,
  imports: [IGX_EXPANSION_PANEL_DIRECTIVES, ReactiveFormsModule, NgIf, CardListComponent, DeckCardsComponent],
